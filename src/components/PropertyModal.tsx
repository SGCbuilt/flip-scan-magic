  ...
  return (
    <div className="fixed inset-0 z-[100] flex">
      ...
      <div className="relative ml-auto w-full max-w-2xl h-full bg-zinc-950 border-l border-zinc-800 flex flex-col shadow-2xl slide-in">
        ...
        {/* Header */}
        <div className={`flex-shrink-0 border-b border-zinc-800 ${isHot ? 'bg-emerald-950/20' : 'bg-zinc-900/60'}`}>
          {/* Accent line */}
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  ...
                  {p.underMoms && <span className="text-[9px] border border-emerald-500/40 text-emerald-400 px-2 py-0.5 rounded-full">70% Rule ✓</span>}
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <button onClick={onClose} className="text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800 w-8 h-8 rounded-lg flex items-center justify-center transition-colors cursor-pointer bg-transparent border-none text-lg">✕</button>
              </div>
            </div>
          ...
          {/* Tabs */}
          <div className="flex border-t border-zinc-800/60 px-2">
            {TABS.map(t => (
